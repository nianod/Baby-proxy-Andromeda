...
const LoginScreen = () => {
  ...
  const login = async () => {
    ...
    if (!formData.email || !formData.password) {
      setError({
        email: formData.email ? "" : "Email is require",
      ...
      >
        <View className="min-h-screen px-6 pb-5 flex-1 pt-20">
          <View className="items-center mb-10">
            ...
            <View className="mt-10 w-full bg-gray-50 p-6 rounded-md shadow-xl">
              <View>
                ...
                <TextInput
                  className={`border px-4 py-3 rounded-xl text-base ${
              ...
              <View className="mt-5 relative">
                ...
                <View className="justify-center">
                  ...
                  <TextInput
                    className={`font-medium border rounded-xl text-base px-5 py-3 pr-12 text-gray-700 ${
                      error.password ? "border-red-500" : "border-green-500"
                    }`}
          ...
          <View className="flex-row justify-center gap-1">
            ...
            <TouchableOpacity>
              <Text className="text-blue-500 font-semibold" onPress={Register}>
                Sign up
              </Text>
            </TouchableOpacity>
          </View>
